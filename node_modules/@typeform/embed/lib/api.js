...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_preact__ = __webpack_require__(81);
...
var _messagePropagation = __webpack_require__(44);

var _messagePropagation2 = _interopRequireDefault(_messagePropagation);
...
var checkEmbedId = exports.checkEmbedId = function checkEmbedId(embedId, event) {
  return event.detail && event.detail.embedId === embedId;
};

var callIfEmbedIdMatches = exports.callIfEmbedIdMatches = function callIfEmbedIdMatches(func, embedId) {
...
var broadcastMessage = exports.broadcastMessage = function broadcastMessage(embedId, event) {
  if (event.data.embedId === embedId) {
    (0, _messagePropagation2.default)(event);
  }
};
...
exports.omit = omit;
var redirectToUrl = exports.redirectToUrl = function redirectToUrl(event) {
...
var _createEmotion = __webpack_require__(88);

var _createEmotion2 = _interopRequireDefault(_createEmotion);

var _createEmotionStyled = __webpack_require__(93);
...
var _isUrl = __webpack_require__(86);
...
var acceptMessageOrigin = function acceptMessageOrigin(event) {
  ...
  var matches = event.origin.match(re);
...
exports.default = function (event) {
  ...
  if ((0, _isUrl2.default)(event.data)) {
    window.location.href = event.data;
    return;
  }

  if ((0, _isobject2.default)(event.data) && event.data.hasOwnProperty('type')) {
    window.dispatchEvent(new _customEvent2.default(event.data.type, {
      detail: event.data
    }));
    return;
  }

  window.dispatchEvent(new _customEvent2.default(event.data));
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3)))
...
var _scrollbarWidth = __webpack_require__(87);
...
var _spinner = __webpack_require__(95);
...
}, ';left:0;top:0;right:0;bottom:0;z-index:10001;min-height:100%;');
...
var Popup = function (_Component) {
  ...
  function Popup(props) {
    ...
    _this.handleKeyDown = (0, _utils.callIfEmbedIdMatches)(_this.handleKeyDown.bind(_this), _this.props.embedId);
    _this.handleAutoClose = (0, _utils.callIfEmbedIdMatches)(_this.handleAutoClose.bind(_this), _this.props.embedId);
    _this.handleClose = (0, _utils.callIfEmbedIdMatches)(_this.handleClose.bind(_this), _this.props.embedId);
    _this.handleFormSubmit = (0, _utils.callIfEmbedIdMatches)(_this.handleFormSubmit.bind(_this), _this.props.embedId);
    _this.handleIframeLoad = _this.handleIframeLoad.bind(_this);
    _this.handleAnimateBeforeClose = _this.handleAnimateBeforeClose.bind(_this);
  ...
  _createClass(Popup, [{
    ...
    value: function componentDidMount() {
      ...
      window.addEventListener('redirect-after-submit', _utils.redirectToUrl);
      window.addEventListener('thank-you-screen-redirect', _utils.redirectToUrl);
    ...
    value: function componentWillUnmount() {
      ...
      window.removeEventListener('redirect-after-submit', _utils.redirectToUrl);
      window.removeEventListener('thank-you-screen-redirect', _utils.redirectToUrl);
    }
  }, {
    key: 'setWrapperRef',
    ...
    value: function handleAnimateBeforeClose() {
      var _this4 = this;
    ...
    value: function handleMessage(event) {
      (0, _utils.broadcastMessage)(this.props.embedId, event);
    }
  }, {
    key: 'handleAutoClose',
    value: function handleAutoClose(event) {
      var _this5 = this;

      var canSetAutocloseDelay = event.detail.isProPlus || event.detail.canSetAutocloseDelay;
      ...
      if (isAutoCloseEnabled) {
        setTimeout(function () {
          _this5.handleAnimateBeforeClose();
        }, timeout);
      }
    }
  }, {
...
var _closeIcon = __webpack_require__(98);
...
var _dataService = __webpack_require__(49);
...
}, ';position:fixed !important;z-index:10001;left:0 !important;right:0 !important;top:0 !important;bottom:0 !important;overflow:hidden !important;height:100%;transition:all 400ms ease ', function (props) {
  ...
  _createClass(MobileModal, [{
    ...
    value: function handleAutoClose(event) {
      ...
      var _props = this.props,
          ...
          _props$autoClose = _props.autoClose,
          autoClose = _props$autoClose === undefined ? _popup.DEFAULT_AUTOCLOSE_TIMEOUT : _props$autoClose;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        open && _react2.default.createElement(_iframe2.default, { src: iframeUrl }),
...
var _fetchJsonp = __webpack_require__(99);
...
var _makePopup = __webpack_require__(74);

var _makePopup2 = _interopRequireDefault(_makePopup);

var _makeWidget = __webpack_require__(100);

var _makeWidget2 = _interopRequireDefault(_makeWidget);

var _makeFullscreen = __webpack_require__(102);
...
var _randomString = __webpack_require__(45);
...
var _mobileModal = __webpack_require__(48);
...
function makePopup(url, options) {
  var embedId = (0, _randomString2.default)();
  ...
  var popup = {
    ...
    close: function close() {
      window.postMessage({ type: 'form-closed', embedId: embedId }, '*');
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__emotion_memoize__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__emotion_unitless__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__emotion_hash__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__emotion_stylis__ = __webpack_require__(91);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_stylis_rule_sheet__ = __webpack_require__(92);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__emotion_is_prop_valid__ = __webpack_require__(94);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__emotion_memoize__ = __webpack_require__(47);
...
var Widget = function (_Component) {
  ...
  function Widget(props) {
    ...
    _this.embedId = (0, _randomString2.default)();
    _this.mobileEmbedId = (0, _randomString2.default)();
    ...
    _this.handleMessage = _this.handleMessage.bind(_this);
    _this.handleFormReady = (0, _utils.callIfEmbedIdMatches)(_this.handleFormReady.bind(_this), _this.embedId);
    _this.handleFormSubmit = (0, _utils.callIfEmbedIdMatches)(_this.handleFormSubmit.bind(_this), _this.embedId);
    _this.goFullScreen = (0, _utils.callIfEmbedIdMatches)(_this.goFullScreen.bind(_this), _this.embedId);
  ...
  _createClass(Widget, [{
    ...
    key: 'setIframeRef',
    value: function setIframeRef(node) {
      this.iframe = node;
    }
  }, {
    key: 'goFullScreen',
    ...
    key: 'handleMessage',
    value: function handleMessage(event) {
      (0, _utils.broadcastMessage)(this.embedId, event);
    }
  }, {
    key: 'handleFormSubmit',
    value: function handleFormSubmit() {
    ...
    value: function render() {
      ...
      var inlineIframeUrl = (0, _utils.updateQueryStringParameter)('typeform-embed-id', this.embedId, url);
...
function makeFullScreen(iframe, url, options) {
  ...
  window.addEventListener('message', _messagePropagation2.default);
...
var internalFind = __webpack_require__(112)(5);
var FIND = 'find';
...
var codePointAt = __webpack_require__(123);
var InternalStateModule = __webpack_require__(22);
...
var hostReportErrors = __webpack_require__(139);
...
if (FORCED) {
  ...
  Internal.prototype = __webpack_require__(141)(PromiseConstructor.prototype, {
